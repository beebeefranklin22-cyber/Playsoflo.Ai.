...
const memeTemplates = [
  ...
  },
  {
    ...
    topText: "Me",
    bottomText: "Something else"
  },
  {
    id: "success",
    name: "Success Kid",
    url: "https://i.imgflip.com/1bhk.jpg",
    topText: "When you succeed",
    bottomText: "Success!"
  },
  {
    id: "fry",
  ...
  },
  {
    ...
    topText: "Hard choice",
    bottomText: "Can't decide"
  },
  {
    id: "woman",
    name: "Woman Yelling at Cat",
    url: "https://i.imgflip.com/345v97.jpg",
    topText: "Angry person",
    bottomText: "Confused cat"
  },
  {
    id: "bernie",
    name: "Bernie Sanders",
    url: "https://i.imgflip.com/4x6d.jpg",
    topText: "I am once again",
    bottomText: "Asking for support"
  },
  {
    id: "ralph",
    name: "I'm In Danger",
...
export default function MemeCreator() {
  ...
  const generateAIMeme = async () => {
    ...
    try {
      const prompt = `Generate a funny, creative meme text combination. Return ONLY a JSON object with "topText" and "bottomText" properties. Make it witty and relatable for 2024.`;
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-white flex items-center gap-3">
              <Laugh className="w-8 h-8 text-pink-400" />
              Meme Creator
            </h1>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-pink-400 font-semibold mb-1">Keep it Short</p>
                <p className="text-gray-300">Short, punchy text works best. Less is more!</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-pink-400 font-semibold mb-1">Use AI</p>
                <p className="text-gray-300">Let AI generate witty text combinations for you</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-pink-400 font-semibold mb-1">Share Everywhere</p>
                <p className="text-gray-300">Download and share your memes on social media</p>
              </div>
            </div>
          </CardContent>
        </Card>
