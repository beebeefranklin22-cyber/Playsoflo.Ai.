  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div
          className={`flex items-center gap-3 p-3 ${(destinationUrl || ad) ? 'cursor-pointer' : ''}`}
          onClick={handleClick}
        >
          {/* Image */}
          {imageUrl ? (
            <img src={imageUrl} alt={headline} className="w-14 h-14 rounded-xl object-cover flex-shrink-0" />
          ) : (
          ...
          <div className="flex-1 min-w-0 pr-6">
            ...
            <p className="text-white font-semibold text-sm truncate">{headline}</p>
          ...
          {destinationUrl && (
            <div className="flex-shrink-0">
              <span className="text-xs text-purple-300 font-semibold flex items-center gap-1 whitespace-nowrap">
