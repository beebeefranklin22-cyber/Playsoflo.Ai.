        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-52 bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden max-h-80 overflow-y-auto"
            >
              {locales.map(locale => (
                <button
                  key={locale.code}
