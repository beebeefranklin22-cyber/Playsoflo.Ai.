  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-xl rounded-3xl border-2 border-purple-500/50 shadow-2xl max-w-2xl w-full max-h-[90dvh] overflow-hidden"
      >
