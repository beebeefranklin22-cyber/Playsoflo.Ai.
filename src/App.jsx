...
const AuthenticatedApp = () => {
  const [skipGate, setSkipGate] = React.useState(false)
  const { isLoadingAuth, isLoadingPublicSettings, authError, isAuthenticated, navigateToLogin, user, refreshUser } = useAuth()
